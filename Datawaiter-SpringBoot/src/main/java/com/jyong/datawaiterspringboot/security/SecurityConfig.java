package com.jyong.datawaiterspringboot.security;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers("/").permitAll()   // "/"代表首页  permitAll()代表允许所有人访问
                .antMatchers("/level1").hasAnyRole("vip1")  //level1 下的功能页面 仅vip1可访问，下同
